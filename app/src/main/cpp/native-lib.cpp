...
Java_com_darren_optimize_day06_NativeCrashMonitor_nativeInit(JNIEnv *env, jobject nativeCrashMonitor,
                                                             jobject callback) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_darren_optimize_day06_NativeCrashMonitor_nativeSetup(JNIEnv *env, jobject thiz) {
    // 设置监听信号量回调处理
...
extern "C"
JNIEXPORT void JNICALL
Java_com_darren_optimize_day06_NativeCrashMonitor_nativeCrash(JNIEnv *env, jclass clazz) {
